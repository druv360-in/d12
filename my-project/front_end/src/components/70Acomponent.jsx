...
const SeventyAComponent = ({ selectedPlan = "Large", onPlanChange }) => {
  ...
  return (
    <div className="p-3 bg-gray-50">
      {/* SELECT PAYMENT PLAN */}
      <p className="text-m font-semibold text-gray-400 mb-3">SELECT PAYMENT PLAN</p>
      ...
      <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 mb-4">
        <div className="bg-violet-700 px-4 py-3 flex items-center gap-2">
          ...
          <p className="text-white font-bold text-m">SKILLBUSTER ESCROW PROTECTION</p>
        </div>
        <div className="p-7">
          <p className="text-m text-gray-700 leading-relaxed mb-3">
          ...
          <div className="flex flex-wrap gap-2">
            {["Secure Holding", "Client-Controlled Release", "Dispute Resolution", "Refund Policy"].map((item) => (
              <span key={item} className="flex items-center gap-2 bg-violet-50 text-violet-700 text-s font-semibold px-3 py-2 rounded-full">
      ...
      {/* PROJECT CARD */}
      <div className="bg-gradient-to-br from-violet-700 via-violet-600 to-amber-400 rounded-2xl p-8 text-white shadow-lg">
        ...
        <h2 className="text-xl font-bold mb-5 leading-tight">{data.project}</h2>
